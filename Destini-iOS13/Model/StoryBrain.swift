...
struct StoryBrain {
    ...
    func getChoice1Destination() -> Int {
        return getCurrentStory().choice1Destination
    }
  
    func getChoice2Destination() -> Int {
        return getCurrentStory().choice2Destination
    }
    ...
    func getStoriesQuantity() -> Int {
        return stories.count
    }
    
    mutating func nextStory(userChoice: String) {
        if userChoice == getChoice1() {
            storyNumber = getChoice1Destination()
        } else {
            storyNumber = getChoice2Destination()
        }
    }
